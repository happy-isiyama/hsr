...
def move_arm_to_point(point):
    # Move the arm to the target point slightly above the target point
    whole_body.move_end_effector_pose(geometry.pose(x=point.point.z-0.1, y=point.point.x, z=point.point.x- 0.1), _HAND_TF)
